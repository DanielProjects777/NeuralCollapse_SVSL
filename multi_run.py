...
# config_paths = [r"C:\daniel\mfoml\MFOML\NeuralCollapse\Vision\configs\MNIST_Resnet18_2.p"]


# config_paths = [r"/home/ubuntu/projects/MFOML_CourseExamples/NeuralCollapse/Vision/configs/MNIST_Resnet18_2.p"]


# r"/home/ubuntu/projects/MFOML_CourseExamples/NeuralCollapse/Vision/configs/FashionMNIST_Resnet18_2.p"]


def get_math_hyper_params_list():
    lst_to_return = []
    mid_lst_to_return = [
        MathHyperParams(alpha=10 ** (-4), gamma=4, config_path=LOCAL_MNIST, stop_batch=20,
                        svsl_loss_type='non_batched'),
        MathHyperParams(alpha=10 ** (-4), gamma=2, config_path=SERVER_MNIST, stop_batch=20,
                        svsl_loss_type='non_batched'),
        MathHyperParams(alpha=10 ** (-4), gamma=4, config_path=SERVER_MNIST, stop_batch=40,
                        svsl_loss_type='non_batched'),
        MathHyperParams(alpha=10 ** (-4), gamma=2, config_path=SERVER_MNIST, stop_batch=40,
                        svsl_loss_type='non_batched')
    ]
